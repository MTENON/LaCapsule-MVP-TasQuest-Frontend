...
function ButtonCircleEmpty({icon, variant}){
    const buttonStyles = {
        primary: { backgroundColor: "transparent", border: "3px solid #A50104" },
        secondary: { backgroundColor: "transparent", border: "3px solid #FCD757" },
    };
...
export default ButtonCircleEmpty;
